  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Item.giftEntries.findById() instead.
        "prototype$__findById__giftEntries": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/items/:id/giftEntries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Item.giftEntries.destroyById() instead.
        ...
        // INTERNAL. Use Item.giftEntries.updateById() instead.
        ...
        // INTERNAL. Use Item.giftEntries() instead.
        "prototype$__get__giftEntries": {
          isArray: true,
          url: urlBase + "/items/:id/giftEntries",
          method: "GET"
        },

        // INTERNAL. Use Item.giftEntries.create() instead.
        "prototype$__create__giftEntries": {
          url: urlBase + "/items/:id/giftEntries",
          method: "POST"
        },

        // INTERNAL. Use Item.giftEntries.destroyAll() instead.
        "prototype$__delete__giftEntries": {
          url: urlBase + "/items/:id/giftEntries",
          method: "DELETE"
        },

        // INTERNAL. Use Item.giftEntries.count() instead.
        "prototype$__count__giftEntries": {
          url: urlBase + "/items/:id/giftEntries/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Product.items.findById() instead.
        "::findById::Product::items": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/products/:id/items/:fk",
          method: "GET"
        },

        // INTERNAL. Use Product.items.destroyById() instead.
        "::destroyById::Product::items": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/products/:id/items/:fk",
        ...
        // INTERNAL. Use Product.items.updateById() instead.
        "::updateById::Product::items": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/products/:id/items/:fk",
        ...
        // INTERNAL. Use Product.items() instead.
        "::get::Product::items": {
          isArray: true,
          url: urlBase + "/products/:id/items",
          method: "GET"
        },

        // INTERNAL. Use Product.items.create() instead.
        "::create::Product::items": {
          url: urlBase + "/products/:id/items",
          method: "POST"
        },

        // INTERNAL. Use Product.items.createMany() instead.
        "::createMany::Product::items": {
          isArray: true,
          url: urlBase + "/products/:id/items",
          method: "POST"
        },

        // INTERNAL. Use Product.items.destroyAll() instead.
        "::delete::Product::items": {
          url: urlBase + "/products/:id/items",
          method: "DELETE"
        },

        // INTERNAL. Use Product.items.count() instead.
        "::count::Product::items": {
          url: urlBase + "/products/:id/items/count",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Item.giftEntries
     * @header lbServices.Item.giftEntries
     * @object
     * @description
     *
     * The object `Item.giftEntries` groups methods
     * manipulating `GiftEntry` instances related to `Item`.
     *
     * Call {@link lbServices.Item#giftEntries Item.giftEntries()}
     ...
     */
        ...
        R.giftEntries = function() {
          ...
          var action = TargetResource["::get::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#count
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
         * Counts giftEntries of Item.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.giftEntries.count = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::count::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#create
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.create = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::create::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#createMany
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.createMany = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::createMany::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#destroyAll
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.destroyAll = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::delete::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#destroyById
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.destroyById = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::destroyById::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#findById
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.findById = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::findById::Item::giftEntries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Item.giftEntries#updateById
         * @methodOf lbServices.Item.giftEntries
         *
         * @description
         *
        ...
        R.giftEntries.updateById = function() {
          var TargetResource = $injector.get("GiftEntry");
          var action = TargetResource["::updateById::Item::giftEntries"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiftEntry#checkPin
         * @methodOf lbServices.GiftEntry
         *
         * @description
         *
         ...
         */
        "checkPin": {
          url: urlBase + "/giftEntries/check-pin",
          method: "POST"
        },

        // INTERNAL. Use Item.giftEntries.findById() instead.
        "::findById::Item::giftEntries": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/items/:id/giftEntries/:fk",
        ...
        // INTERNAL. Use Item.giftEntries.create() instead.
        "::create::Item::giftEntries": {
          url: urlBase + "/items/:id/giftEntries",
          method: "POST"
        },

        // INTERNAL. Use Item.giftEntries.createMany() instead.
        "::createMany::Item::giftEntries": {
          isArray: true,
          url: urlBase + "/items/:id/giftEntries",
          method: "POST"
        },
        ...
        // INTERNAL. Use Item.giftEntries.destroyAll() instead.
        "::delete::Item::giftEntries": {
          url: urlBase + "/items/:id/giftEntries",
          method: "DELETE"
        },

        // INTERNAL. Use Item.giftEntries.count() instead.
        "::count::Item::giftEntries": {
          url: urlBase + "/items/:id/giftEntries/count",
          method: "GET"
        },
      }
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Product.items
     * @header lbServices.Product.items
     * @object
     * @description
     *
     * The object `Product.items` groups methods
     * manipulating `Item` instances related to `Product`.
     *
     * Call {@link lbServices.Product#items Product.items()}
     * to query all related instances.
     */
        ...
        R.items = function() {
          ...
          var action = TargetResource["::get::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#count
         * @methodOf lbServices.Product.items
         *
         * @description
         *
         * Counts items of Product.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.items.count = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::count::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#create
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.create = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::create::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#createMany
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.createMany = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::createMany::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#destroyAll
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.destroyAll = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::delete::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#destroyById
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.destroyById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::destroyById::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#findById
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.findById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::findById::Product::items"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Product.items#updateById
         * @methodOf lbServices.Product.items
         *
         * @description
         *
        ...
        R.items.updateById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::updateById::Product::items"];
          return action.apply(R, arguments);
        };
