  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use GiverReceiver.location() instead.
        "::get::GiverReceiver::location": {
          url: urlBase + "/giverReceivers/:id/location",
          method: "GET"
        },

        // INTERNAL. Use GiverReceiver.location.create() instead.
        "::create::GiverReceiver::location": {
          url: urlBase + "/giverReceivers/:id/location",
          method: "POST"
        },

        // INTERNAL. Use GiverReceiver.location.createMany() instead.
        "::createMany::GiverReceiver::location": {
          isArray: true,
          url: urlBase + "/giverReceivers/:id/location",
          method: "POST"
        },

        // INTERNAL. Use GiverReceiver.location.update() instead.
        "::update::GiverReceiver::location": {
          url: urlBase + "/giverReceivers/:id/location",
          method: "PUT"
        },

        // INTERNAL. Use GiverReceiver.location.destroy() instead.
        "::destroy::GiverReceiver::location": {
          url: urlBase + "/giverReceivers/:id/location",
          method: "DELETE"
        },
      }
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use GiftEntry.receiver() instead.
        "prototype$__get__receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "GET"
        },

        // INTERNAL. Use GiftEntry.receiver.create() instead.
        "prototype$__create__receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "POST"
        },

        // INTERNAL. Use GiftEntry.receiver.update() instead.
        "prototype$__update__receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "PUT"
        },

        // INTERNAL. Use GiftEntry.receiver.destroy() instead.
        "prototype$__destroy__receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "DELETE"
        },
    ...
    */
     ...
     * manipulating `GiverReceiver` instances related to `GiftEntry`.
     *
     ...
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `GiverReceiver` object.)
         * </em>
         */
        R.giver = function() {
          var TargetResource = $injector.get("GiverReceiver");
    ...
    /**
     * @ngdoc object
     * @name lbServices.GiftEntry.receiver
     * @header lbServices.GiftEntry.receiver
     * @object
     * @description
     *
     * The object `GiftEntry.receiver` groups methods
     * manipulating `GiverReceiver` instances related to `GiftEntry`.
     *
     * Call {@link lbServices.GiftEntry#receiver GiftEntry.receiver()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation receiver.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.receiver = function() {
          var TargetResource = $injector.get("GiverReceiver");
          var action = TargetResource["::get::GiftEntry::receiver"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiftEntry.receiver#create
         * @methodOf lbServices.GiftEntry.receiver
         *
         * @description
         *
         * Creates a new instance in receiver of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.receiver.create = function() {
          var TargetResource = $injector.get("GiverReceiver");
          var action = TargetResource["::create::GiftEntry::receiver"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiftEntry.receiver#createMany
         * @methodOf lbServices.GiftEntry.receiver
         *
         * @description
         *
         ...
         * </em>
         */
        R.receiver.createMany = function() {
          var TargetResource = $injector.get("GiverReceiver");
          var action = TargetResource["::createMany::GiftEntry::receiver"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiftEntry.receiver#destroy
         * @methodOf lbServices.GiftEntry.receiver
         *
         * @description
         *
         * Deletes receiver of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.receiver.destroy = function() {
          var TargetResource = $injector.get("GiverReceiver");
          var action = TargetResource["::destroy::GiftEntry::receiver"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiftEntry.receiver#update
         * @methodOf lbServices.GiftEntry.receiver
         *
         * @description
         *
         * Update receiver of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.receiver.update = function() {
          var TargetResource = $injector.get("GiverReceiver");
          var action = TargetResource["::update::GiftEntry::receiver"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.GiverReceiver
 * @header lbServices.GiverReceiver
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `GiverReceiver` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#create
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/giverReceivers",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#createMany
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#upsert
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#exists
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/giverReceivers/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#findById
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/giverReceivers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#find
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#findOne
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/giverReceivers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#updateAll
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/giverReceivers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#deleteById
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#count
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/giverReceivers/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#prototype$updateAttributes
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#createChangeStream
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/giverReceivers/change-stream",
          method: "POST"
        },
        ...
        // INTERNAL. Use GiftEntry.receiver() instead.
        "::get::GiftEntry::receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "GET"
        },

        // INTERNAL. Use GiftEntry.receiver.create() instead.
        "::create::GiftEntry::receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "POST"
        },

        // INTERNAL. Use GiftEntry.receiver.createMany() instead.
        "::createMany::GiftEntry::receiver": {
          isArray: true,
          url: urlBase + "/giftEntries/:id/receiver",
          method: "POST"
        },
        ...
        // INTERNAL. Use GiftEntry.receiver.update() instead.
        "::update::GiftEntry::receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "PUT"
        },

        // INTERNAL. Use GiftEntry.receiver.destroy() instead.
        "::destroy::GiftEntry::receiver": {
          url: urlBase + "/giftEntries/:id/receiver",
          method: "DELETE"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#updateOrCreate
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#update
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#destroyById
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver#removeById
         * @methodOf lbServices.GiverReceiver
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.GiverReceiver#modelName
    * @propertyOf lbServices.GiverReceiver
    * @description
    * The name of the model represented by this $resource,
    * i.e. `GiverReceiver`.
    */
    R.modelName = "GiverReceiver";

    /**
     * @ngdoc object
     * @name lbServices.GiverReceiver.location
     * @header lbServices.GiverReceiver.location
     * @object
     * @description
     *
     * The object `GiverReceiver.location` groups methods
     * manipulating `Location` instances related to `GiverReceiver`.
     *
     * Call {@link lbServices.GiverReceiver#location GiverReceiver.location()}
     * to query all related instances.
     */
        ...
        R.location = function() {
          ...
          var action = TargetResource["::get::GiverReceiver::location"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver.location#create
         * @methodOf lbServices.GiverReceiver.location
         *
         * @description
         *
        ...
        R.location.create = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::create::GiverReceiver::location"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver.location#createMany
         * @methodOf lbServices.GiverReceiver.location
         *
         * @description
         *
        ...
        R.location.createMany = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::createMany::GiverReceiver::location"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver.location#destroy
         * @methodOf lbServices.GiverReceiver.location
         *
         * @description
         *
        ...
        R.location.destroy = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::destroy::GiverReceiver::location"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.GiverReceiver.location#update
         * @methodOf lbServices.GiverReceiver.location
         *
         * @description
         *
        ...
        R.location.update = function() {
          var TargetResource = $injector.get("Location");
          var action = TargetResource["::update::GiverReceiver::location"];
          return action.apply(R, arguments);
        };
